...
export const metadata: Metadata = {
  ...
  description:
    "Magnetic-switch keyboards engineered for the 0.1mm difference. Analog input. Instant response. No compromises.",
  ...
  openGraph: {
    title: "SIGNAL — Precision Reimagined",
    description: "Magnetic-switch keyboards engineered for the 0.1mm difference.",
    type: "website",
    ...
    <html lang={locale} data-theme="dark" data-scroll-behavior="smooth">
      <head>
        <style>{`
          ...
          html[lang="zh"] .font-mono { font-family: var(--font-mono); }
          html[lang="ja"] .font-mono { font-family: var(--font-mono); }
          html[lang="ko"] .font-mono { font-family: var(--font-mono); }
        `}</style>
      </head>
